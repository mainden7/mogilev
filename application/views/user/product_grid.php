<div class="top-bread">
    <ul>
        ...
        <li><a href="#">Блоки с системой паз-гребень</a></li>
    </ul>
</div>
<section id="product">
    ...
    <div class="range width-range">
        ...
        <input id="width" name="width" type="range" min="0" max="99" step="1" value=""/>
        <div class="range-min">
            <p>Наименьшая</p>
        </div>
        <div class="range-max">
...
<section id="product-tech-char">
    <div class="content">
        <div class="wrapper">
            <div class="center-content">
                ...
                <div class="product-advantages">
                    <div class="headline">
                        <p>Преимущества структуры паз-гребень:</p>
                    </div>
                    <ul>
                        <li>
                            <p>Более тонкий шов при использовании блоков паз-гребень, снижает теплопотери строения. </p>
                        </li>
                        <li>
                            <p>Значительная экономия клеевого раствора при кладке блоков паз-гребень. </p>
                        </li>
                        <li>
                            <p>Более ровная кладка, так как блоки паз-гребень плотнее прилегают друг к другу и их проще выравнивать</p>
                        </li>
                    </ul>
                </div>
                <div class="headline">
        ...
        <div class="char-table" id="system-paz-table">
        ...
        <div class="center-content">
            ...
            <div class="nb">
                ...
                <p>По согласованию с заказчиком допускается изготовление изделий нестандартных размеров. Например, изготовление изделий с высотой = 600 мм.  </p>
            </div>
            <div class="pack">
                <div class="caption">
                    <p>Упаковка:</p>
