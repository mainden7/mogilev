							...
							<table class="table table-hover">
								...
								foreach ($order_items as $order_item) { ?>
									<tr>
										...
										<td>
											<?php
												if($order_item['category'] == 'Плиты' OR $order_item['category'] == 'Инструменты'){
													echo $order_item['name'];
												}elseif($order_item['category'] == 'Блоки'){
													echo $order_item['block_category'];
												}
											?>
										</td>
										<td><?php echo $order_item['category'] ?></td>
										<td><?php echo str_replace('|', 'x', $order_item['size']) ?></td>
