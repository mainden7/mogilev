<script src="<?php echo base_url(); ?>/application/resources/js/lib/summernote/summernote.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.11.2/js/bootstrap-select.min.js"></script>
<link rel="stylesheet" href="<?php echo base_url(); ?>/application/resources/css/lib/summernote/summernote.css"/>
					...
					<?php foreach($data['projects'] AS $project) { ?>
						<div class="gallery-col">
							<article class="gallery-item">
								<img class="gallery-picture" src="<?php echo base_url() ?>application/resources/user_resources/img/<?php echo $project['img'] ?>" alt="<?php echo $project['name'] ?>" height="158">
						...
						<div id="editProject<?php echo $project['id'] ?>" class="modal fade" role="dialog">
						    <div class="modal-dialog">
						        ...
						        <div class="modal-content">
						            ...
						            <form class="form-horizontal mt25 ml50" action="<?php echo base_url(); ?>admin_panel/edit_project" method="POST"   enctype="multipart/form-data">
						                <div class="modal-body">
						                    <div class="form-group">
						                    	<label for="name" class="control-label">Название проекта</label>
