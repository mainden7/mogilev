...
.. php:function:: base_url($uri = '', $protocol = NULL)
	...
	This function returns the same thing as :php:func:`base_url()`, without
	the *index_page* or *url_suffix* being appended.

	Also like :php:func:`base_url()`, you can supply segments as a string or
	...
	*http://example.com/blog/post/123*
	...
	This is useful because unlike :php:func:`base_url()`, you can supply a
...
.. php:function:: anchor($uri = '', $title = '', $attributes = '')
	...
	URL. As with the :php:func:`base_url()` function above, segments can
